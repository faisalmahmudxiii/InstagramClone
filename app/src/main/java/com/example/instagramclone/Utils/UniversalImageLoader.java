...
public class UniversalImageLoader {
    ...
    /**
     * this method can only be used for ststic images
     * cant be used if the image are being changed in the fragment/activity or
     * they are being set on a grid or list.
     * @param imageURL
     * @param imageView
     * @param mProgressBar
     * @param append
